...
```
Agent(
  prompt="Read E:/Proyectos Github/brahcaciones/.gemini/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/templates/SECURITY.md`
