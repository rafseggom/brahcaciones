...
<required_reading>
@E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/references/user-story-template.md
@E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/references/spidr-splitting.md
@E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `conversational prompting` calls. Each is free-text. After all three, assemble into the canonical sentence per `@E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/references/spidr-splitting.md`. Briefly:
