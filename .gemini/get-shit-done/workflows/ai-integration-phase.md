...
<required_reading>
@E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/references/ai-frameworks.md
@E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read E:/Proyectos Github/brahcaciones/.gemini/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read E:/Proyectos Github/brahcaciones/.gemini/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read E:/Proyectos Github/brahcaciones/.gemini/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read E:/Proyectos Github/brahcaciones/.gemini/agents/gsd-eval-planner.md for instructions.
