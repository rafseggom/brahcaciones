...
Key references:
- @E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/references/ui-brand.md (display patterns)
- @E:/Proyectos Github/brahcaciones/.gemini/agents/gsd-user-profiler.md (profiler agent definition)
- @E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/USER-PROFILE.md"
...
```bash
cp "E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/USER-PROFILE.md" "E:/Proyectos Github/brahcaciones/.gemini/USER-PROFILE.backup.md"
```
...
✓ Stores profile at E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/references/user-profiling.md`
...
Reference: @E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to E:/Proyectos Github/brahcaciones/.gemini/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at E:/Proyectos Github/brahcaciones/.gemini/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to E:/Proyectos Github/brahcaciones/.gemini/CLAUDE.md"
...
```bash
BACKUP_PATH="E:/Proyectos Github/brahcaciones/.gemini/USER-PROFILE.backup.md"
```
...
Your profile:    E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   E:/Proyectos Github/brahcaciones/.gemini/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        E:/Proyectos Github/brahcaciones/.gemini/CLAUDE.md
```
