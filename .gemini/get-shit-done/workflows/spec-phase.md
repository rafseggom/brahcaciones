...
```bash
INIT=$(node "E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/templates/spec.md.
