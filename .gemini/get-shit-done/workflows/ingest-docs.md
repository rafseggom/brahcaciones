...
```bash
INIT=$(node "E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/bin/gsd-tools.cjs" commit \
