...
INSTALL_JS_GLOBAL="E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
