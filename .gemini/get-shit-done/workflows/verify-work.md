...
<template>
@E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/workflows/transition.md`.
...
- Follow @E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/workflows/diagnose-issues.md
