...
- Usage: Reference from command with `@E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to E:/Proyectos Github/brahcaciones/.gemini/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to E:/Proyectos Github/brahcaciones/.gemini/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
