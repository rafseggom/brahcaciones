...
<!-- For checkpoint task examples and patterns, see @E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/references/checkpoints.md -->
...
See `E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/workflows/verify-phase.md` for verification logic.
