...
<reference>
@E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/references/user-profiling.md` to load:
