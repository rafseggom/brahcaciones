...
Reference full template: `E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `E:/Proyectos Github/brahcaciones/.gemini/get-shit-done/templates/state.md`.
